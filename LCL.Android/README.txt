...
下面是src目录的子目录：
src<br>
lcl.android.activity<br> — APP界面包
lcl.android.adapter<br>  — APP列表适配器包
lcl.android.api<br> — API访问包
lcl.android.control<br>— APP控件包
lcl.android.core<br> — APP启动及管理包
lcl.android.fragment<br>— APP界面包
lcl.android.mail<br>
lcl.android.rss<br>
lcl.android.sms<br>
lcl.android.test<br>
lcl.android.utility<br> — APP工具包
